...
from instaparcer.items import InstaparcerItem
import re
import json
...
class InstaspiderSpider(scrapy.Spider):
    ...
    insta_login = 'ollibright'
    insta_pwd = '#PWD_INSTAGRAM_BROWSER:9:1607438422:AVdQABb72E5W+7L4aFb3TPKqY24SorM4ZoWLHlEXGEoYxd0N+UHmXXUcK5w8H5gtiufC0WdLl0ZYDnzxce64mGbL3I+hPmsjS9XF90N/gTzvVUz1puHLfCuqkvriujcllsLZHl2y/l9Tr+dV4X7vqkS1rQ=='
    inst_login_link = 'https://www.instagram.com/accounts/login/ajax/'
    parse_user = ['mts.official', 'mts_bank']     #Пользователь, у которого собираем подписчиков и подписки. Можно указать список
